  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main">
      ...
      <el-table :data="books" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
        ...
        <el-table-column prop="author" label="学生证" width="100" sortable></el-table-column>
        <el-table-column prop="publishAt" label="身份证" width="150" sortable></el-table-column>
      ...
      <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
        <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
          ...
          <el-form-item label="学生证" prop="author">
    ...
    data(){
      return {
        ...
        editFormRules: {
          ...
          author: [
            {required: true, message: '请输入学生证', trigger: 'blur'}
          ],
          description: [
