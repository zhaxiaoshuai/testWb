...
*/  import {closeWebSocket1,createWebSocket1,sendWebSocketMessage1} from '../api/webSocket';
  ...
  export default {
    ...
    mounted() {
      ...
      //创建websocket,进入连接新websocket
      createWebSocket1();


/*      setTimeout(testFunction(),"6000"); //6000毫秒后执行testFunction()函数，只执行一次。
*/
      //全局函数setMessageInnerHTML绑定
      window.setMessageInnerHTML = this.setMessageInnerHTML.bind(this);
    }
  }
